...
public class WebsiteCrawlerTest {
	...
	public void invalidUrl_noProtocol() {
		new WebsiteCrawler("example.com", new ThreadListener());
	}
	...
	public void validUrl_http() {
		new WebsiteCrawler("http://example.com", new ThreadListener());
	}

	@Test
	public void validUrl_https() {
		new WebsiteCrawler("https://example.com", new ThreadListener());
	}
}
